...
\midrule
\textbf{Este trabajo} & \textbf{2026} & \textbf{Colombia} & \textbf{38.245} & \textbf{203.104} & \textbf{XGB+SHAP} & \textbf{Por det.} & \textbf{S\'i} & \textbf{S\'i} \\
\bottomrule
\end{longtable}
}
...
\addlinespace
Integraci\'on web & Solo \citet{MayorgaLira2023} (una cooperativa peruana); FinTech regional concentrada en capitales \citep{Ioannou2022} & Sistema web completo (React.js + Node.js + PostgreSQL + servicio ML en Python) para ciudades intermedias \\
\addlinespace
